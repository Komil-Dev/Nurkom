...
const translations = {
    uz: {
        ...
        "portfolio-official-bot": "Rasmiy Botga o'tish",
    ...
    en: {
        ...
        "portfolio-official-bot": "Go to Official Bot",
    ...
    ru: {
        ...
        "portfolio-official-bot": "Перейти к официальному боту",
...
function initContactForm() {
    ...
    const BOT_TOKEN = "7471873187:AAHyO1pnz30aXf-K7kJvKe3WsgPFdE4VyLE";
    ...
    contactForm.addEventListener('submit', async function (e) {
        ...
        submitText.textContent = sendingTexts[currentLang];
...
💬 Xabar: ${message}
        ...
        try {
            ...
            if (result.ok) {
                ...
                <div class="bg-[rgba(0,255,170,0.1)] p-4 rounded-lg mt-4">
                    <p class="text-[#00FFAA]">${successMessages[currentLang]}</p>
                </div>
                `;
            ...
            const errorMessages = {
                uz: 'Xabar yuborishda xatolik yuz berdi. Iltimos, qayta urinib ko\'ring yoki biz bilan to\'g\'ridan-to\'g\'ri bog\'laning.',
                en: 'An error occurred while sending the message. Please try again or contact us directly.',
                ru: 'Произошла ошибка при отправке сообщения. Пожалуйста, попробуйте еще раз или свяжитесь с нами напрямую.'
            };

            formStatus.innerHTML = `
            <div class="bg-[rgba(255,100,100,0.1)] p-4 rounded-lg mt-4">
                <p class="text-red-400">${errorMessages[currentLang]}</p>
            </div>
            `;
            formStatus.classList.remove('hidden');
        } finally {
            ...
            submitText.textContent = submitTexts[currentLang];

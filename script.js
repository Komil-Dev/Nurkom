...
const translations = {
  uz: {
    ...
    "portfolio-description2":
      "Akademiya haqida ma'lumot beruvchi platforma. Mavjud kurslar karta ko'rinishida taqdim etiladi, har birida to'liq ma'lumot mavjud.",
    "portfolio2-description":
      "HMM Export kompaniyasi uchun yaratilgan ushbu veb-sayt mijozlarga mahsulotlar bilan tanishish, buyurtma berish, kompaniya haqida ma'lumot olish va yangiliklaridan xabardor bo'lish imkonini beradi.",
    "portfolio3-description":
      "Abdushukur Zamin Baraka firmasi uchun yaratilgan sayt foydalanuvchilarga quruq mevalar haqidagi ma'lumotlar, xizmatlar, qo'llab-quvvatlash imkoniyatlari va yangiliklarni taqdim etadi.",
    "portfolio4-description":
      "Wedday ilovasi uchun yaratilgan sayt foydalanuvchilarga ilova haqidagi ma'lumotlar, xizmatlar, qo'llab-quvvatlash imkoniyatlari va yangiliklarni taqdim etadi.",
    "portfolio5-description":
      "TCA Group kompaniyasi uchun yaratilgan ushbu veb-sayt kompaniya haqida batafsil ma'lumot olish, ishlab chiqarilgan ilovalar portfelini ko'rish va bog'lanish imkoniyatlarini taqdim etadi.",
    "portfolio6-description":
      "Bitiruvchi Lentalar kompaniyasi uchun yaratilgan ushbu veb-sayt mijozlarga mahsulotlar bilan tanishish, buyurtma berish va kompaniya haqida ma'lumot olish imkonini beradi.",
    "portfolio7-description":
      "Do'stlik Arena mini stadion boti orqali bugungi va ertangi o'yinlarni bron qilish, bekor qilish, stadion haqida ma'lumot olish, statistikani ko'rish mumkin va admin bilan bog'lanish imkoniyatini beradi.",
    "portfolio8-description":
      "Sodiq Consulting uchun yaratilgan sayt foydalanuvchilarga kompaniya haqidagi ma'lumotlar, ko'rsatiladigan xizmatlar, mijozlar uchun qo'llab-quvvatlash imkoniyatlari va sohadagi yangiliklarni taqdim etadi.",
    ...
    "contact-description":
      "Sizning loyihangiz bo'yicha maslahat olish yoki xizmatlarimiz haqida ko'proq ma'lumot olish uchun bizga murojaat qiling.",
    ...
    "footer-copyright": "© 2026 Nurkom. Barcha huquqlar himoyalangan.",
    ...
    "plan2-feature5": "Database integratsiyasi",
    "plan2-feature6": "3 oy bepul texnik yordam",
  ...
  en: {
    ...
    "portfolio-description2":
      "A platform providing information about the academy. Available courses are presented in card format, each containing complete information.",
    "portfolio2-description":
      "This website created for HMM Export company allows customers to get acquainted with products, place orders, get information about the company and stay updated with news.",
    "portfolio3-description":
      "The site created for Abdushukur Zamin Baraka company provides users with information about dried fruits, services, support opportunities and news.",
    "portfolio4-description":
      "The site created for Wedday application provides users with information about the app, services, support opportunities and news.",
    "portfolio5-description":
      "This website created for TCA Group company provides detailed information about the company, viewing the portfolio of developed applications and contact opportunities.",
    "portfolio6-description":
      "This website created for Bitiruvchi Lentalar company allows customers to get acquainted with products, place orders and get information about the company.",
    "portfolio7-description":
      "Through the Do'stlik Arena mini stadium bot, you can book today's and tomorrow's games, cancel, get information about the stadium, view statistics and contact the admin.",
    "portfolio8-description":
      "The site created for Sodiq Consulting provides users with information about the company, services provided, support opportunities for clients and industry news.",
    ...
    "form-submit": "Send",
    "footer-copyright": "© 2026 Nurkom. All rights reserved.",
    ...
    "plan2-feature4": "Admin panel",
    "plan2-feature5": "Database integration",
    "plan2-feature6": "3 months free technical support",
  ...
  ru: {
    ...
    "portfolio-description2":
      "Платформа, предоставляющая информацию об академии. Доступные курсы представлены в виде карточек, каждая из которых содержит полную информацию.",

    "portfolio2-description":
      "Этот веб-сайт, созданный для компании HMM Export, позволяет клиентам ознакомиться с продуктами, размещать заказы, получать информацию о компании и быть в курсе новостей.",
    "portfolio3-description":
      "Сайт, созданный для компании Abdushukur Zamin Baraka, предоставляет пользователям информацию о сухофруктах, услугах, возможностях поддержки и новостях.",
    "portfolio4-description":
      "Сайт, созданный для приложения Wedday, предоставляет пользователям информацию о приложении, услугах, возможностях поддержки и новостях.",
    "portfolio5-description":
      "Этот веб-сайт, созданный для компании TCA Group, предоставляет подробную информацию о компании, просмотр портфолио разработанных приложений и возможности связи.",
    "portfolio6-description":
      "Этот веб-сайт, созданный для компании Bitiruvchi Lentalar, позволяет клиентам ознакомиться с продуктами, размещать заказы и получать информацию о компании.",
    "portfolio7-description":
      "Через бот мини-стадиона Do'stlik Arena можно бронировать сегодняшние и завтрашние игры, отменять, получать информацию о стадионе, просматривать статистику и связываться с администратором.",
    "portfolio8-description":
      "Сайт, созданный для Sodiq Consulting, предоставляет пользователям информацию о компании, предоставляемых услугах, возможностях поддержки клиентов и новостях отрасли.",
    ...
    "footer-copyright": "© 2026 Nurkom. Все права защищены.",
    ...
    "plan2-feature5": "Интеграция базы данных",
    "plan2-feature6": "3 месяца бесплатной технической поддержки",
